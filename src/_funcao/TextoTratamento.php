...
class TextoTratamento
{
	...
	public static function replaceLista($texto): String
	{
		...
		$correcoesLista = Array(
			...
			"height='22 &lt;" => "height='22'&gt;&lt;",
			"width='38   'height='38'" => "width='38' height='38'",
			"'vspace =' - 8" => "vspace='-8'",
			"vspace='- 8'" => "vspace='-8'",
			//'lt;Font' => 'lt;font',
			//' &lt;font' => '&amp;lt;',
			...
			' br /' => 'br/',
			"width =' 113   '" => "width='113' ",
			'"Textures/cursor /3"&lt;' => '"Textures/ccursor3"&gt;&lt;',
			"&Rhythm:" => "'&gt;Ritmo:",
			"&lt;br/&gt;&br; " => "Com um Zornhau rápido da posição do Boi, pare o golpe do oponente para o lado ",
			'full straight' => 'totalmente direto',
			'reta parcial' => 'parcial direto',
			'Goodman' => 'Bom homem',
			'goodman' => 'bom homem',
			'Pa esta com' => 'Pai esta com',
			'Curriculo' => 'Retomar',
			'sim' => 'Sim',
			'asSim' => 'assim',
			'Salto!' => 'Calcanhar!',
			...
			'Ax&lt;' => 'Machado&lt;',
			"'#512D00&gt;" => "'#512D00'&gt;",
			"'#512D00 'Rhythm:" => "'#512D00'&gt;Ritmo:",
			'O ocioso de sangue azul.' => 'O preguicoso de sangue azul.',

			'Eu gostaria de dinheiro.' => "Eu gostaria de algum dinheiro.", # TUTORIAL
			'Hoje e um arrasador, nao e?' => "Hoje está quente, não é?", # DIALOGO
			'< O uso de curativos' => "O uso de curativos",
			"'#512D00 'Rhytm:" => "'#512D00'&gt; Ritmo:&lt;/font&gt;slash – stab – stab&lt;br/&gt;&lt;br/&gt;Por meio de ataques rápidos, coloque o oponente na defensiva e finja uma facada, mas, em vez de executá-la, execute um Mittlehau ao redor da lâmina do oponente diretamente para o rosto.",
			//'"' => "'", # TUTORIAL
			//'de doces.' => "certo.", # TUTORIAL
